const Navbar = function () {
    return (
            ...
            <nav className="glass-nav rounded-xl bg-nav bg-gradient-to-br from-[#d3cef6] to-[#e5e0f8] md:left-6 md:right-6 md:top-6 md:rounded-4xl text-white flex items-center justify-between px-4 md:px-8 py-3 md:py-4 fixed md:w-auto z-20 w-full">
  {/* Left: Logo */}
